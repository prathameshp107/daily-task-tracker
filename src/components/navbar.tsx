...
import { Bell, Plus, Settings, User, LogOut, ChevronDown, BarChart3, Home, Menu, Clock, CheckCircle, Calendar, Zap, CalendarCheck, CalendarX, Settings as SettingsIcon, FolderOpen, Download } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        {isAuthenticated && (
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link href="/autofetchtasks">
              <Button 
                variant={pathname === "/autofetchtasks" ? "default" : "ghost"} 
                size="sm"
                className="flex items-center gap-2 px-3 py-1.5 h-9 transition-all hover:scale-[1.02]"
              >
